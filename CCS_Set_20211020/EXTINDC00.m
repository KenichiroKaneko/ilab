function [GW,GR,GZ] = EXTINDC00(XP,YP,X1,Y1,X2,Y2,X3,Y3)
...
%
    GW(1) = sum(PHI(1:16).*OME(1:16).*XJA(1:16).*F1(1:16));
    GW(2) = sum(PHI(1:16).*OME(1:16).*XJA(1:16).*F2(1:16));
    GW(3) = sum(PHI(1:16).*OME(1:16).*XJA(1:16).*F3(1:16));
    GR(1) = sum(PHIA(1:16).*OME(1:16).*XJA(1:16).*F1(1:16));
    GR(2) = sum(PHIA(1:16).*OME(1:16).*XJA(1:16).*F2(1:16));
    GR(3) = sum(PHIA(1:16).*OME(1:16).*XJA(1:16).*F3(1:16));
    GZ(1) = sum(PHIB(1:16).*OME(1:16).*XJA(1:16).*F1(1:16));
    GZ(2) = sum(PHIB(1:16).*OME(1:16).*XJA(1:16).*F2(1:16));
    GZ(3) = sum(PHIB(1:16).*OME(1:16).*XJA(1:16).*F3(1:16));